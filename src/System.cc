    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    else
    {
        ...
        //mpAtlas->CreateNewMap(); originally: creates a new map; the loaded map is used only for merging
        //Set the loaded map as the current one
...
bool System::LoadAtlas(int type)
{
    ...
    if(type == TEXT_FILE) // File text
    {
        cout << "Loading Atlas (text)..." << endl;
        std::ifstream ifs(pathLoadFileName, std::ios::binary);
        if(!ifs.good())
        {
            cout << "Atlas file not found" << endl;
            return false;
        }
        ...
        ia >> strVocChecksum;
        ia >> mpAtlas;
        cout << "... Atlas loaded ok (text)" << endl;
        isRead = true;
    }
    else if(type == BINARY_FILE) // File binary
    {
        cout << "Loading Atlas (binary)..."  << endl;
        std::ifstream ifs(pathLoadFileName, std::ios::binary);
        if(!ifs.good())
        {
            cout << "Atlas file not found" << endl;
        ...
        ia >> strVocChecksum;
        ia >> mpAtlas;
        cout << "... Atlas loaded ok (binary)" << endl;
        isRead = true;
    }
